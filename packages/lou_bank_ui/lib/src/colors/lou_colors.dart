...
abstract class LouColors {
  ...
  static const gradientYellowEnd = Color(0xffF1FE87);
  static const gradientLilacStart = Color(0xffF2EFF4);
  static const gradientLilacEnd = Color(0xffB8A9C6);
  static const gradientGreyStart = Color(0xff252525);
  static const gradientGreyEnd = Color(0xff2C2C2C);
}
